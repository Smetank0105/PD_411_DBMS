--ALTER DATABASE [PD_411_ALL_IN_ONE] SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
--DROP DATABASE PD_411_ALL_IN_ONE;

CREATE DATABASE PD_411_ALL_IN_ONE_3
ON
(
	NAME		=	PD_411_ALL_IN_ONE_3, --Логическое имя файла 
	FILENAME	=	'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\PD_411_ALL_IN_ONE_3.mdf', --физическое имя файла
	SIZE		=	8MB,
	MAXSIZE		=	500MB,
	FILEGROWTH	=	5MB
...
LOG ON 
(
	NAME		=	PD_411_ALL_IN_ONE_3,
	FILENAME	=	'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\PD_411_ALL_IN_ONE_3_log.ldf',
	SIZE		=	8MB,
	MAXSIZE		=	500MB,
	FILEGROWTH	=	8MB
);
...
(
	...
	CONSTRAINT FK_DD_Discipline_2_Discipline_Relation	FOREIGN KEY (discipline)			REFERENCES Disciplines(discipline_id),
